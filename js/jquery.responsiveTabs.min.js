...
!function(t, s, a) {
    ...
    e.prototype._loadEvents = function() {
        for (var t = this, a = function(a) {
            ...
            o.disabled || (t.options.setHash && (history.pushState ? history.pushState(null, null, s.location.origin + s.location.pathname + s.location.search + o.selector) : s.location.hash = o.selector),
